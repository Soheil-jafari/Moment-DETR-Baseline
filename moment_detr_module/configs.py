...
class Config:
    def __init__(self):
        self.seed = 42; self.dataset_name = "cholec80"; self.num_workers = 8
        ...
        self.nheads = 8; self.dropout = 0.1; self.pre_norm = True
        self.position_embedding = 'sine'
        self.span_loss_type = 'l1'; self.ce_loss = False
        self.giou_loss_coef = 2.0; self.l1_loss_coef = 5.0
        self.eos_coef = 0.1; self.no_object_weight = 0.1
        self.epochs = 50; self.lr = 1e-4; self.lr_backbone = 1e-5
        self.lr_drop = 40; self.batch_size = 16
